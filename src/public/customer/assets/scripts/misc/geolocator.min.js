;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof define == 'function' && define.amd) define('geolocator', [], factory)
  else if (typeof exports == 'object') exports['geolocator'] = factory()
  else root['geolocator'] = factory()
})(this, function() {
    ...
    /******/ [
          ...
          _createClass(fetch, null, [
            {
              ...
              value: function jsonp(options, callback) {
                ...
                var script = document.createElement('script'),
                  cbParamSet =
                    _utils2.default.isString(options.callbackParam) &&
                    options.callbackParam.trim() !== '',
                  cbFnName = void 0,
                  root = void 0,
                  rootNameSet =
                    _utils2.default.isString(options.rootName) &&
                ...
                script.onerror = function(error) {
                  var errMsg =
                    'Could not load source at ' + _utils2.default.removeQuery(options.url)
                  if (error) {
                    errMsg += '\n' + (error.message || error)
                  }
      ...
      /***/ function(module, exports, __webpack_require__) {
          ...
          _createClass(geolocator, null, [
            ...
            },
            {
              ...
              value: function getStaticMap(options, callback) {
                if (!_utils2.default.isPlainObject(options) || !options.center) {
                  throw new _geo4.default(
                    _geo4.default.Code.INVALID_PARAMETERS,
                ...
                var center = _utils2.default.isPlainObject(opts.center)
                  ? opts.center.latitude + ',' + opts.center.longitude
                  : String(opts.center)

                var size = _utils2.default.isPlainObject(opts.size)
                  ? opts.size.width + 'x' + opts.size.height
                  : String(opts.size)

                var url =
                  _enums2.default.URL.GOOGLE_SATATIC_MAP + // not using utils.setProtocol() here
            ...
            },
            {
              ...
              value: function createMap(options, callback) {
                ...
                if (
                  !_utils2.default.isPlainObject(options.center) ||
                  !_utils2.default.isNumber(options.center.latitude) ||
                  !_utils2.default.isNumber(options.center.longitude)
                ) {
                  throw new _geo4.default(
                    _geo4.default.Code.INVALID_PARAMETERS,
                ...
                geolocator.ensureGoogleLoaded(key, function(err) {
                  if (err) {
                    throw new _geo4.default(
                      _geo4.default.Code.GOOGLE_API_FAILED,
            ...
            },
            {
              ...
              value: function locateByMobile(options, callback) {
                ...
                var conf = geolocator._.config,
                  key = conf.google.key || '',
                  url = _utils2.default.setProtocol(
                    _enums2.default.URL.GOOGLE_GEOLOCATION,
                    conf.https
                  ),
                  xhrOpts = {
                    url: url + '?key=' + key,
            ...
            },
            {
              ...
              value: function locateByIP(options, callback) {
                ...
                if (!_utils2.default.isPlainObject(source)) {
                  throw new _geo4.default(
                    _geo4.default.Code.INVALID_GEO_IP_SOURCE,
            ...
            },
            {
              ...
              value: function getTimeZone(options, callback) {
                if (
                  !_utils2.default.isPlainObject(options) ||
                  !_utils2.default.isNumber(options.latitude) ||
                  !_utils2.default.isNumber(options.longitude)
                ) {
                  throw new _geo4.default(_geo4.default.Code.INVALID_PARAMETERS)
                }
                ...
                var url = _utils2.default.setProtocol(
                    _enums2.default.URL.GOOGLE_TIMEZONE,
                    conf.https
                  ),
                  xhrOpts = {
                    url:
            ...
            },
            {
              ...
              value: function getDistanceMatrix(options, callback) {
                ...
                geolocator.ensureGoogleLoaded(key, function(err) {
                  ...
                  if (
                    !_utils2.default.isPlainObject(options) ||
                    invalidOriginOrDest(o) ||
                    invalidOriginOrDest(d)
                  ) {
                    throw new _geo4.default(_geo4.default.Code.INVALID_PARAMETERS)
                  }
                  ...
                  service.getDistanceMatrix(options, function(response, status) {
                    ...
                    if (status !== google.maps.DistanceMatrixStatus.OK) {
                      err =
                        _geo4.default.fromResponse(status) || _geo4.default.fromResponse(response)
                      response = null
                    } else {
                      response = options.raw
                        ? response
                        : _geo2.default.formatDistanceResults(response)
                    }
                    callback(err, response)
                  })
                })
            ...
            },
            {
              ...
              value: function calcDistance(options) {
                ...
                var from = options.from,
                  to = options.to,
                  radius =
                    options.unitSystem == geolocator.UnitSystem.METRIC
                      ? EARTH_RADIUS_KM
                      : EARTH_RADIUS_MI
            ...
            },
            {
              ...
              value: function getIP(callback) {
                ...
                return _fetch2.default.jsonp(jsonpOpts, function(err, response) {
                  ...
                  if (
                    (typeof response == 'undefined' ? 'undefined' : _typeof(response)) == 'object'
                  )
                    response.timestamp = _utils2.default.time()
            ...
            },
            {
              ...
              value: function decToDegMinSec(dec) {
                ...
                return (
                  Math.floor(absValue / 1000000) * sign +
                  '° ' +
                  Math.floor((absValue / 1000000 - Math.floor(absValue / 1000000)) * 60) +
                  "' " +
                  (Math.floor(
                    ((absValue / 1000000 - Math.floor(absValue / 1000000)) * 60 -
                      Math.floor((absValue / 1000000 - Math.floor(absValue / 1000000)) * 60)) *
                      100000
                  ) *
                    60) /
        ...
        function invalidOriginOrDest(value) {
          return (
            !_utils2.default.isString(value) &&
            !_utils2.default.isArray(value) &&
            !_utils2.default.isPlainObject(value)
          )
        }
        ...
        function checkGoogleKey(options) {
          if (
            ...
            if (!geolocator._.config.google.key) {
              throw new _geo4.default(
                _geo4.default.Code.GOOGLE_KEY_INVALID,
        ...
        function getMapOpts(mapOptions, location) {
          ...
          if (
            !mapOptions.zoom &&
            location.coords &&
            _utils2.default.isNumber(location.coords.accuracy) &&
        ...
        function setLocationURLs(location, options) {
          ...
          if (options.staticMap) {
            var opts = _utils2.default.isPlainObject(options.staticMap)
              ? _utils2.default.clone(options.staticMap)
              : {}
        ...
        function locateAccurate(options, onPositionReceived, onPositionError) {
          var loc = void 0,
            watcher = void 0,
            onProgress = !_utils2.default.isFunction(options.onProgress)
        ...
        function getStyles(options) {
          var conf = geolocator._.config
          return !_utils2.default.isFilledArray(options.styles)
            ? _utils2.default.isFilledArray(conf.google.styles)
              ? conf.google.styles
              : null
            : options.styles
        }
        ...
        var geoHelper = {
          ...
          formatGeocodeResults: function formatGeocodeResults(results) {
            ...
            return {
              ...
              address: {
                commonName:
                  o.point_of_interest || o.premise || o.subpremise || o.colloquial_area || '',
                streetNumber: o.street_number || '',
                street:
                  o.administrative_area_level_4 || o.administrative_area_level_3 || o.route || '',
                route: o.route || '',
                neighborhood:
                  o.neighborhood ||
            ...
            styles.forEach(function(v, i, a) {
              ...
              if (v.stylers) {
                ...
                if (v.stylers.length > 0) {
                  ...
                  style +=
                    (v.hasOwnProperty('featureType') ? 'feature:' + v.featureType : 'feature:all') +
                    '|'
                  style +=
                    (v.hasOwnProperty('elementType') ? 'element:' + v.elementType : 'element:all') +
                    '|'
            ...
            },
            {
              ...
              value: function clear(delay, callback) {
                ...
                var d = _utils2.default.isNumber(delay) ? delay : 0,
                  cb = _utils2.default.isFunction(callback)
                    ? callback
                    : _utils2.default.isFunction(delay)
                    ? delay
                    : null
