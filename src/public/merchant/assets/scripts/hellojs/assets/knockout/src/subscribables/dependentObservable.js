...
ko.computed = ko.dependentObservable = function(
  ...
  var state = {
    ...
    disposeWhenNodeIsRemoved:
      options['disposeWhenNodeIsRemoved'] || options.disposeWhenNodeIsRemoved || null,
...
var computedFn = {
  ...
  evaluateImmediate: function(notifyChange) {
    ...
    if (
      (state.disposeWhenNodeIsRemoved &&
        !ko.utils.domNodeIsAttachedToDocument(state.disposeWhenNodeIsRemoved)) ||
  ...
  peek: function() {
    ...
    if (
      (state.isStale && !state.dependenciesCount) ||
