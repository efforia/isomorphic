function RichMarker(e) {
  var t = e || {}
  ;(this.ready_ = !1),
    (this.dragging_ = !1),
    void 0 == e.visible && (e.visible = !0),
    void 0 == e.shadow && (e.shadow = '7px -3px 5px rgba(88,88,88,0.7)'),
    void 0 == e.anchor && (e.anchor = RichMarkerPosition.BOTTOM),
    this.setValues(t)
}
;(RichMarker.prototype = new google.maps.OverlayView()),
  ...
  (RichMarker.prototype.setVisible = function(e) {
    this.set('visible', e)
  }),
  (RichMarker.prototype.setVisible = RichMarker.prototype.setVisible),
  (RichMarker.prototype.visible_changed = function() {
    this.ready_ &&
      ((this.markerWrapper_.style.display = this.getVisible() ? '' : 'none'), this.draw())
  }),
  (RichMarker.prototype.visible_changed = RichMarker.prototype.visible_changed),
  (RichMarker.prototype.setFlat = function(e) {
    this.set('flat', !!e)
  }),
  ...
  (RichMarker.prototype.setShadow = function(e) {
  ...
  (RichMarker.prototype.setZIndex = function(e) {
    this.set('zIndex', e)
  }),
  ...
  (RichMarker.prototype.setDraggable = function(e) {
    this.set('draggable', !!e)
  }),
  (RichMarker.prototype.setDraggable = RichMarker.prototype.setDraggable),
  (RichMarker.prototype.draggable_changed = function() {
    this.ready_ &&
      (this.getDraggable() ? this.addDragging_(this.markerWrapper_) : this.removeDragListeners_())
  }),
  ...
  (RichMarker.prototype.setPosition = function(e) {
    this.set('position', e)
  }),
  ...
  (RichMarker.prototype.setAnchor = function(e) {
    this.set('anchor', e)
  }),
  ...
  (RichMarker.prototype.htmlToDocumentFragment_ = function(e) {
  ...
  (RichMarker.prototype.removeChildren_ = function(e) {
    if (e) for (var t; (t = e.firstChild); ) e.removeChild(t)
  }),
  (RichMarker.prototype.setContent = function(e) {
    this.set('content', e)
  }),
  ...
  (RichMarker.prototype.content_changed = function() {
    if (this.markerContent_) {
      ...
      if (e) {
        'string' == typeof e &&
          ((e = e.replace(/^\s*([\S\s]*)\b\s*$/, '$1')), (e = this.htmlToDocumentFragment_(e))),
          this.markerContent_.appendChild(e)
        for (
          var t, r = this, i = this.markerContent_.getElementsByTagName('IMG'), o = 0;
          (t = i[o]);
          o++
        )
          google.maps.event.addDomListener(t, 'mousedown', function(e) {
  ...
  (RichMarker.prototype.setCursor_ = function(e) {
    if (this.ready_) {
      var t = ''
      ;-1 !== navigator.userAgent.indexOf('Gecko/')
        ...
        : (('dragging' != e && 'dragready' != e) || (t = 'move'),
          'draggable' == e && (t = 'pointer')),
        this.markerWrapper_.style.cursor != t && (this.markerWrapper_.style.cursor = t)
    }
  }),
  ...
  (RichMarker.prototype.drag = function(e) {
    if (this.getDraggable() && this.dragging_) {
      var t = this.mouseX_ - e.clientX,
        r = this.mouseY_ - e.clientY
      ;(this.mouseX_ = e.clientX), (this.mouseY_ = e.clientY)
      var i = parseInt(this.markerWrapper_.style.left, 10) - t,
        o = parseInt(this.markerWrapper_.style.top, 10) - r
      ;(this.markerWrapper_.style.left = i + 'px'), (this.markerWrapper_.style.top = o + 'px')
      var a = this.getOffset_(),
        s = new google.maps.Point(i - a.width, o - a.height),
        n = this.getProjection()
      this.setPosition(n.fromDivPixelToLatLng(s)),
  ...
  (RichMarker.prototype.removeDragListeners_ = function() {
    this.draggableListener_ &&
      (google.maps.event.removeListener(this.draggableListener_), delete this.draggableListener_),
      this.setCursor_('')
  }),
  (RichMarker.prototype.addDragging_ = function(e) {
    if (e) {
      var t = this
  ...
  (RichMarker.prototype.getOffset_ = function() {
    ...
    var r = this.markerContent_.offsetWidth,
  ...
  (RichMarker.prototype.onAdd = function() {
    if (
      ...
      google.maps.event.addDomListener(this.markerContent_, 'click', function(t) {
        ...
        google.maps.event.addDomListener(this.markerContent_, 'mouseover', function(t) {
          google.maps.event.trigger(e, 'mouseover')
        }),
        google.maps.event.addDomListener(this.markerContent_, 'mouseout', function(t) {
    ...
    if (this.ready_ && !this.dragging_) {
      ...
      if (e) {
        var t = this.get('position'),
          ...
          i = this.getOffset_()
        ;(this.markerWrapper_.style.top = r.y + i.height + 'px'),
          (this.markerWrapper_.style.left = r.x + i.width + 'px')
        var o = this.markerContent_.offsetHeight,
          a = this.markerContent_.offsetWidth
        a != this.get('width') && this.set('width', a),
          o != this.get('height') && this.set('height', o)
      }
    }
  }),
