            ...
            <div className="risk-form-page__form__field-group">
              ...
              <div className="risk-form-page__form__field-group__inputs">
                ...
                <p
                  ...
                  Estou ciente que esta resposta reduz o prêmio pago. Compreendi que se no momento
                  do sinistro o veículo estiver sendo utilizado por condutores residentes de 18 a 25
                  anos, não haverá indenização, pois será considerado risco não contratado, exceto
                  se comprovado por documentos idôneos que trata de emergência médica.
                </p>
                <CheckboxInput
                  checked={riskForm.residemComPrincipalCondutor}
                  onClick={() =>
                ...
                <div className={`${!riskForm.residemComPrincipalCondutor ? 'hidden' : ''}`}>
                  <CheckboxInput
                    ...
                    Sim e não utilizam o veículo. Estou ciente que esta resposta reduz o prêmio
                    pago. Compreendi que se no momento do sinistro o veículo estiver sendo utilizado
                    por condutores residentes de 18 a 25 anos, não haverá indenização, pois será
                    considerado risco não contratado, exceto se comprovado por documentos idôneos
                  ...
                  <CheckboxInput
                    ...
                    onClick={() =>
                      this.setState({
                        riskForm: { ...riskForm, youngAdultsUtilization: 'sporadic' }
                      })
                    }>
                  ...
                  <CheckboxInput
                    ...
                    onClick={() =>
                      this.setState({
                        riskForm: { ...riskForm, youngAdultsUtilization: 'the_oldest_is_a_minor' }
                      })
                    }>
                    Sim, o(s) residente(s) mais velho(s) possui(em) 17 anos no momento da
