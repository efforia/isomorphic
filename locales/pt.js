const display_name = process.env.PROJECT_DISPLAY_NAME
const project_email = process.env.PROJECT_CONTACT_EMAIL
...
module.exports = {
  ...
  no_merchant_found_message: `Nenhum estabelecimento foi encontrado na sua região :( <br/> <a href="mailto:${project_email}">Entre em contato</a>, nos avise do seu interesse para que possamos fazer uma experiência mais completa para você!`,
  ...
  no_subscription_plans_found: `Olá! Ainda não há nenhum plano para assinaturas cadastrado. Clique no "+" para adicionar um novo plano )`,
  ...
  order_status_created: `Aguardando confirmação...`,
  order_status_accepted: `Pedido confirmado!`,
  ...
  payment_method_name: `Ex.: Visa (Crédito)`,
  payment_card: `Cartão`,
  ...
  sale_fee_percentage: `Taxa sobre venda`,
  saturday: `Sábado`,
  save: `Salvar`,
  ...
  whoops_total_must_be_higher_than_minimum: `Ops! O pedido mínimo deste estabelecimento é maior do que o total do carrinho. Por favor, adicione algum item e tente novamente )`,
