;(function() {
  ...
  ko.bindingContext.prototype['createChildContext'] = function(
    ...
    return new ko.bindingContext(dataItemOrAccessor, this, dataItemAlias, function(
      self,
      parentContext
    ) {
  ...
  ko.bindingContext.prototype['extend'] = function(properties) {
    ...
    return new ko.bindingContext(this._subscribable || this['$data'], this, null, function(
      self,
      parentContext
    ) {
  ...
  function applyBindingsToNodeAndDescendantsInternal(
    ...
    if (
      shouldBindDescendants &&
      !bindingDoesNotRecurseIntoElementTypes[ko.utils.tagNameLower(nodeVerified)]
    ) {
