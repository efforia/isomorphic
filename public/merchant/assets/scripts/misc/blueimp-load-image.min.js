!(function(e) {
  ...
  var a =
    (e.createObjectURL && e) || (e.URL && URL.revokeObjectURL && URL) || (e.webkitURL && webkitURL)
  ...
  (function(e) {
    ...
    'function' == typeof define && define.amd
      ? define(['./load-image'], e)
      : e('object' == typeof module && module.exports ? require('./load-image') : window.loadImage)
  })(function(e) {
    'use strict'
    var t = e.transform
      ...
      (e.scale = function(t, i, a) {
        ...
        if (
          (b &&
            ...
            i.sourceWidth
              ? ((c = i.sourceWidth),
                void 0 !== i.right && void 0 == i.left && (f = y - c - i.right))
              : (c = y - f - (i.right || 0)),
            i.sourceHeight
              ? ((u = i.sourceHeight),
                void 0 !== i.bottom && void 0 == i.top && (g = x - u - i.bottom))
              : (u = x - g - (i.bottom || 0)),
            (v = c),
            (P = u)),
          (r = i.maxWidth),
          ...
          b && r && s && i.crop
            ? ((v = r),
              (P = s),
              (p = c / u - r / s) < 0
                ? ((u = (s * c) / r), void 0 == i.top && void 0 == i.bottom && (g = (x - u) / 2))
                : p > 0 &&
                  ((c = (r * u) / s), void 0 == i.left && void 0 == i.right && (f = (y - c) / 2)))
            : ((i.contain || i.cover) && ((l = r = r || l), (d = s = s || d)),
              i.cover ? (n(), o()) : (o(), n())),
          b)
        ) {
          if (
              ...
              if (65496 == u.getUint16(0)) {
                ...
                !a.disableImageHead &&
                  ...
                  (c.slice
                    ...
                    : (o.imageHead = new Uint8Array(c).subarray(0, h)))
              ...
              42 == t.getUint16(d + 2, r)
                ? ((s = t.getUint32(d + 4, r)),
                  ...
                  (s = e.parseExifTags(t, d, d + s, r, o)) &&
                    ...
                    l.exif[513] &&
                      (o.exif.Thumbnail = e.getExifThumbnail(t, d + l.exif[513], l.exif[514]))),
                  o.exif[34665] &&
                    !n.disableExifSub &&
                    e.parseExifTags(t, d, d + o.exif[34665], r, o),
                  o.exif[34853] &&
                    !n.disableExifGps &&
                    e.parseExifTags(t, d, d + o.exif[34853], r, o))
  ...
  (function(e) {
    ...
    ;(e.hasCanvasOption = function(i) {
      ...
      (e.transformCoordinates = function(t, i) {
        ...
        if (d && !(d > 8))
          switch (
            (d > 4 && ((t.width = r), (t.height = n), (t.style.width = l), (t.style.height = s)), d)
          ) {
            case 2:
      ...
      (e.getTransformedOptions = function(t, i, a) {
        var n,
          ...
          s = o.call(e, t, i),
          l = s.orientation
        if ((!0 == l && a && a.exif && (l = a.exif.get('Orientation')), !l || l > 8 || 1 == l))
          return s
        n = {}
