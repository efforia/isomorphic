;(function() {
  ...
  function executeTemplate(targetNodeOrNodeArray, renderMode, template, bindingContext, options) {
    options = options || {}
    var firstTargetNode =
      targetNodeOrNodeArray && getFirstNodeFromPossibleArray(targetNodeOrNodeArray)
    ...
    if (targetNodeOrNodeArray) {
      ...
      return ko.dependentObservable(
        ...
        function() {
          ...
          var bindingContext =
            dataOrBindingContext && dataOrBindingContext instanceof ko.bindingContext
              ? dataOrBindingContext
  ...
  ko.renderTemplateForEach = function(
    ...
    return ko.dependentObservable(
      function() {
        ...
        ko.dependencyDetection.ignore(ko.utils.setDomNodeChildrenFromArrayMapping, null, [
          targetNode,
          filteredArray,
