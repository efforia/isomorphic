...
const MarketItem = require('../routes/marketplace/market-items/market-item.model')
const MarketItemCategory = require('../routes/marketplace/market-item-categories/market-item-category.model')
const Picture = require('../routes/pictures/picture.model')
const SEOUtils = require('../services/seo.service')
      ...
      products.map(productRef => {
        return new Promise(async (resolve, reject) => {
          try {
            ...
            const picture = pictureFiles.filter(file => {
              return (
                file &&
                file.metadata &&
                file.metadata.name &&
